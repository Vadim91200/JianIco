...
contract MyToken is ERC20, ERC20Permit {
    ...
    function addToAllowlist(address user, uint8 tier) external onlyOwner {
    ...
    function multiLevelDistribution(address[] memory recipients, uint256[] memory amounts, uint8 tier) external onlyOwner {
    ...
    function mintAndSend(address recipient, uint256 amount) external onlyOwner {
